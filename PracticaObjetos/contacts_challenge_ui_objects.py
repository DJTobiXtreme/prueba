...
from PracticaObjetos import contacts_funcion_contact
...
def search_by_name_or_email(contacts, name_or_email):
    try_dont_found = ""
    name_or_email2 = ""
    name_or_email3 = ""
    while try_dont_found != 2:
        if name_or_email == 1:
            name_or_email2 = "email"
            name_or_email3 = contact.email
        elif name_or_email == 0:
            name_or_email2 = "nombre"
            name_or_email3 = contact.nombre
        search_term = input("Introducir el {} del contacto o parte de él: ".format(name_or_email2))
        found_contacts = []
        ...
        for contact in contacts:
            if name_or_email3.find(search_term) >= 0:
                found_contacts.append(contact)
                print("{} - {}".format(contact_counter, name_or_email3))
...
def find_contact(contacts):
    ...
    name_or_email = ask_until_option_expected([0, 1])
    search_by_name_or_email(contacts, name_or_email)
